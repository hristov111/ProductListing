...
function Toolbar({ shownCount, totalCount, sortBy, onSortChange, onToggleFilters }: ToolbarProps) {
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm text-gray-500">
          Showing <span className="font-semibold text-gray-800">{shownCount}</span> out of{" "}
